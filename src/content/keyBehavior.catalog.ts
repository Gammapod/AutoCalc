...
export const keyBehaviorCatalog: KeyBehaviorSpec[] = [
  ...
  op(KEY_ID.op_euclid_tuple),
  op(KEY_ID.op_eulog),
  op(KEY_ID.op_residual),
  op(KEY_ID.op_log_tuple),
  op(KEY_ID.op_whole_steps),
  op(KEY_ID.op_interval),
  op(KEY_ID.op_mod),
  ...
  {
    key: KEY_ID.viz_state,
    lockModel: "always_unlocked",
    primaryExpectation: "graph_counts_only",
    edgeCaseExpectation: "graph_does_not_mutate_calculator_state",
  },
  {
    key: KEY_ID.viz_number_line,
    lockModel: "unlockable",
    unlockPathPolicy: "none_planned",
    primaryExpectation: "graph_counts_only",
    edgeCaseExpectation: "graph_does_not_mutate_calculator_state",
  ...
  },
  {
    ...
    lockModel: "unlockable",
    unlockPathPolicy: "none_planned",
    primaryExpectation: "roll_inverse_executes_inverse_plan",
    edgeCaseExpectation: "roll_inverse_ambiguous_produces_nan",
  },
];
