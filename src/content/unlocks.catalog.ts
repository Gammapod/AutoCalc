...
export const unlockCatalog: UnlockDefinition[] = [
  ...
  // },
  {
    ...
    description: "Unlock + when roll ends with 4 equal values.",
    predicate: { type: "roll_ends_with_equal_run", length: 4 },
  ...
  // },
  {
    ...
    description: "Unlock 1 when + is pressed the first time.",
    predicate: { type: "key_press_count_at_least", key: "+", count: 1 },
  ...
  },
  {
    ...
    description: "Unlock UNDO when total reaches at least 20.",
  ...
  },
  {
    ...
    description: "Unlock - on first UNDO press.",
    predicate: { type: "key_press_count_at_least", key: "UNDO", count: 1 },
    effect: { type: "unlock_slot_operator", key: "-" },
    once: true,
    domainNodeId: "NN",
