...
const fPrimePlacements: readonly SeedPlacement[] = [
  ...
  { row: 5, col: 4, key: KEY_ID.viz_graph },
  ...
  { row: 3, col: 2, key: KEY_ID.op_eulog },
  { row: 3, col: 1, key: KEY_ID.op_residual },
  ...
  { row: 1, col: 5, key: KEY_ID.unary_phi },
...
const hPrimePlacements: readonly SeedPlacement[] = [
  ...
  { row: 5, col: 2, key: KEY_ID.util_backspace },
  { row: 5, col: 1, key: KEY_ID.util_clear_all },
  { row: 4, col: 4, key: KEY_ID.unary_real_part },
  { row: 4, col: 3, key: KEY_ID.unary_dec },
  { row: 4, col: 2, key: KEY_ID.unary_inc },
  { row: 4, col: 1, key: KEY_ID.unary_real_flip },
  ...
  { row: 2, col: 4, key: KEY_ID.unary_i },
  // { row: 2, col: 3, key: KEY_ID.op_reverse_15 },
  { row: 2, col: 2, key: KEY_ID.unary_rotate_15 },
  { row: 2, col: 1, key: KEY_ID.unary_neg },
...
const iPrimePlacements: readonly SeedPlacement[] = [
  ...
  { row: 5, col: 4, key: KEY_ID.unary_collatz },
  { row: 5, col: 3, key: KEY_ID.op_mod },
  { row: 5, col: 2, key: KEY_ID.op_euclid_tuple },
  { row: 5, col: 1, key: KEY_ID.op_euclid_div },
