...
export const defaultKeyLayout = (): LayoutCell[] => [
  ...
  { kind: "key", key: KEY_ID.viz_ratios },
  { kind: "key", key: KEY_ID.viz_graph },
  { kind: "key", key: KEY_ID.viz_algebraic },
  { kind: "key", key: KEY_ID.op_div },
  { kind: "key", key: KEY_ID.op_eulog },
  { kind: "key", key: KEY_ID.op_residual },
  { kind: "key", key: KEY_ID.op_log_tuple },
  { kind: "key", key: KEY_ID.op_whole_steps },
  { kind: "key", key: KEY_ID.op_interval },
  { kind: "key", key: KEY_ID.op_mod },
  { kind: "key", key: KEY_ID.op_euclid_tuple },
  ...
  { kind: "key", key: KEY_ID.unary_reciprocal },
  { kind: "key", key: KEY_ID.unary_plus_i },
  { kind: "key", key: KEY_ID.unary_minus_i },
  { kind: "key", key: KEY_ID.unary_conjugate },
  { kind: "key", key: KEY_ID.unary_real_flip },
  { kind: "key", key: KEY_ID.unary_imaginary_part },
  { kind: "key", key: KEY_ID.unary_real_part },
  { kind: "key", key: KEY_ID.digit_1 },
  { kind: "key", key: KEY_ID.digit_2 },
  { kind: "key", key: KEY_ID.digit_3 },
  { kind: "key", key: KEY_ID.digit_0 },
  { kind: "key", key: KEY_ID.const_roll_number },
